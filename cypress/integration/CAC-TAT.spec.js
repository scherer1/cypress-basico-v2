...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('campo telefone deve permanecer vazio quando preenchido com valor não numérico', function() {
        cy.get('#phone')
          .type('Teste')
          .should('be.empty')
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function() {
        ...
        cy.get('#lastName')
          .type('Scherer')
          .should('have.value','Scherer')
          .clear()
          .should('be.empty')
        cy.get('#email')
          .type('fabio.scherer@totvs.com.br')
          .should('have.value','fabio.scherer@totvs.com.br')
          .clear()
          .should('be.empty')
        cy.get('#phone')
          .type('991315202')
          .should('have.value','991315202')
          .clear()
          .should('be.empty')
    }) 
